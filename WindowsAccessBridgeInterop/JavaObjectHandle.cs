...
namespace WindowsAccessBridgeInterop
{
    ...
    public class JavaObjectHandle : IDisposable
    {
        ...
        public int JvmId { get; }

        public JOBJECT64 Handle { get; }

        public JOBJECT32 HandleLegacy
        {
            get { return new JOBJECT32((Int32)Handle.Value); }
        }
        ...
        public void Dispose(bool disposing)
        {
            if (IsClosed)
                return;
            RecordDeactivation(Handle);
            EnqueueRelease(JvmId, Handle, _isLegacy);
            IsClosed = true;
        }
